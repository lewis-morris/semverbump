...
- **Extensibility** – support new domains through pluggable analyzers.
...
- Pluggable analyzers for command-line tools, web routes and database
  migrations.
...
Set an analyzer to ``true`` to enable it. Each section configures a different
...
- **analyzers** – toggles built-in or plugin analyzers.
